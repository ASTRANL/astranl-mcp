...
## Live metrics (auto-refreshed daily 02:00 UTC; last refresh 2026-06-13)

- **API version:** v4.0
- **OpenAPI paths exposed:** 707
...
- OpenAPI 3.1.0 spec: https://astranl.com/openapi.json (707 paths)
