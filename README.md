...
## Live metrics (auto-refreshed daily 02:00 UTC; last refresh 2026-07-13)

- **API version:** v4.0
- **OpenAPI paths exposed:** 857
...
- OpenAPI 3.1.0 spec: https://astranl.com/openapi.json (857 paths)
