...
## Live metrics (auto-refreshed daily 02:00 UTC; last refresh 2026-08-02)

- **API version:** v4.0
- **OpenAPI paths exposed:** 818
...
- OpenAPI 3.1.0 spec: https://astranl.com/openapi.json (818 paths)
